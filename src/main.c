...
//     FIELD *fields[7];
//     FORM *form;
//     char username_buffer[31] = {0};  // Store actual username
...
//                 mvwprintw(ui->main_win, 7, 2, "Username: %s", username_buffer);
//                 mvwprintw(ui->main_win, 8, 2, "Password: %s", password_buffer);
//                 mvwprintw(ui->main_win, 9, 2, "Confirm: %s", confirm_buffer);
//                 if (register_user(username_buffer, password_buffer, confirm_buffer) == 0) {
//                     mvwprintw(ui->main_win, 10, 2, "User registered successfully");
//                 } else {
//                     mvwprintw(ui->main_win, 10, 2, "Error registering user");
//                 };
//                 wrefresh(ui->main_win);
//                 break;
...
//                     if (current_field == 0 && strlen(username_buffer) < 30) {
//                         username_buffer[strlen(username_buffer)] = ch;
//                         form_driver(form, ch);
//                     } else if (current_field == 1 && password_len < 30) {
...
//     ATM_UI* ui = init_ui();
    ...
    //     show_message(ui, "Error initializing database", 0, xMax / 2 - 10);
    //     while ((getch()) != 'q')
    //     {
    //         /* code */
    //     }
...
int main() {
    ...
    // switch (ui->content.data.main_menu->current_item) {
    //     case 0: // Login
    //         cleanup_main_menu(ui);
    //         break;
